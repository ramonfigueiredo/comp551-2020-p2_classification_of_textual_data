...
| Dataset             | Number of epochs | Training Accuracy (%) | Loss   |Test Accuracy (%)  | Best number of epochs | 
| ------------------- | ---------------- | --------------------- | ------ | ----------------- | --------------------- |
|  TWENTY_NEWS_GROUPS | 10               | 94.96%                | 0.3695 | 94.96%            | 2                     |
|  IMDB_REVIEWS       | 10               | 96.36%                | 0.2090 | 85.66%            | 6                     |
...
| Dataset             | Number of epochs | Training Accuracy (%) | Loss   |Test Accuracy (%)  | 
| ------------------- | ---------------- | --------------------- | ------ | ----------------- |
|  TWENTY_NEWS_GROUPS | 2               | 94.96%                | 0.5998 | **94.96%**        |
|  IMDB_REVIEWS       | 6               | 94.94%                | 0.3113 | **86.16%**        |
