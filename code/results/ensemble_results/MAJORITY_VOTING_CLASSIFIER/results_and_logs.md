...
| --- | ------------- | ------------------ | ----------------------- | ------------------- |
|  1  |  MAJORITY_VOTING_CLASSIFIER  |  70.37%  |  33.78  |  0.5097  |

#### FINAL CLASSIFICATION TABLE: IMDB_REVIEWS dataset (Binary classification)

| ID | ML Algorithm | Accuracy Score (%) | Training time (seconds) | Test time (seconds) |
| --- | ------------- | ------------------ | ----------------------- | ------------------- |
|  1  |  MAJORITY_VOTING_CLASSIFIER  |  87.88%  |  10.76  |  1.022  |

#### All logs: TWENTY_NEWS_GROUPS dataset and IMDB_REVIEWS dataset (Binary classification)

```
python /comp551-2020-p2_classification_of_textual_data/code/main.py -ml MAJORITY_VOTING_CLASSIFIER
pydev debugger: process 20110 is connecting

Connected to pydev debugger (build 193.6494.30)
Using TensorFlow backend.
2020-03-08 21:58:53.428975: W tensorflow/stream_executor/platform/default/dso_loader.cc:55] Could not load dynamic library 'libnvinfer.so.6'; dlerror: libnvinfer.so.6: cannot open shared object file: No such file or directory
2020-03-08 21:58:53.429027: W tensorflow/stream_executor/platform/default/dso_loader.cc:55] Could not load dynamic library 'libnvinfer_plugin.so.6'; dlerror: libnvinfer_plugin.so.6: cannot open shared object file: No such file or directory
2020-03-08 21:58:53.429032: W tensorflow/compiler/tf2tensorrt/utils/py_utils.cc:30] Cannot dlopen some TensorRT libraries. If you would like to use Nvidia GPU with TensorRT, please make sure the missing libraries mentioned above are installed properly.
03/08/2020 09:58:54 PM - INFO - Program started...
...
Running with options: 
	Dataset = ALL
	ML algorithm list (If ml_algorithm_list is not provided, all ML algorithms will be executed) = ['MAJORITY_VOTING_CLASSIFIER']
...
done in 1.384520s at 9.954MB/s
n_samples: 11314, n_features: 101321

Extracting features from the test data using the same vectorizer
done in 0.756546s at 10.920MB/s
...
VotingClassifier(estimators=[('complement_nb',
                 ...
                 flatten_transform=True, n_jobs=-1, voting='hard',
                 weights=None)
pydev debugger: process 20229 is connecting

pydev debugger: process 20255 is connecting

pydev debugger: process 20250 is connecting

pydev debugger: process 20216 is connecting

pydev debugger: process 20234 is connecting

pydev debugger: process 20222 is connecting

pydev debugger: process 20239 is connecting

pydev debugger: process 20244 is connecting

pydev debugger: process 20272 is connecting

pydev debugger: process 20269 is connecting

pydev debugger: process 20265 is connecting

pydev debugger: process 20264 is connecting
...
Best algorithm:
===> 1) MAJORITY_VOTING_CLASSIFIER
		Accuracy score = 70.37%		Training time = 33.78		Test time = 0.5097
...
Extracting features from the training data using a vectorizer
done in 3.647746s at 9.083MB/s
n_samples: 25000, n_features: 74170

Extracting features from the test data using the same vectorizer
done in 3.618474s at 8.940MB/s
n_samples: 25000, n_features: 74170
...
Best algorithm:
===> 1) MAJORITY_VOTING_CLASSIFIER
		Accuracy score = 87.88%		Training time = 10.76		Test time = 1.022



DONE!
Program finished. It took 93.1007969379425 seconds
